import 'package:cestile_app/screens/home/components/product_card.dart';
                    ...
                    children: [
                      for(int i = 0; i < catList.length; i++) 
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: catList[i] == "All" ? Color(0xFFFD725A) : Color(0xFFF7F8FA),
                            borderRadius: BorderRadius.circular(18)
                          ),
                          child: Text(catList[i], style: TextStyle(
                            fontSize: 16,
                            color: catList[i] == "All" ? Color(0xFFF7F8FA) : Colors.grey,
                          )),
                        )
                    ],
                  ),
